...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='product_type',
            field=models.ForeignKey(db_comment='Tipo de Producto al que pertenece el Producto.', on_delete=django.db.models.deletion.PROTECT, to='inventory.producttype', verbose_name='Tipo de Producto'),
        ),
        migrations.CreateModel(
            name='UserProduct',
            fields=[
